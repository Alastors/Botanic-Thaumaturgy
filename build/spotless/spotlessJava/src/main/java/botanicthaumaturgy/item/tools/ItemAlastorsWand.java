package botanicthaumaturgy.item.tools;
...
import botanicthaumaturgy.block.BlockArcaneMarble;
import botanicthaumaturgy.block.BlockArcaneMarbleBrick;
...
public class ItemAlastorsWand extends Item {
    ...
    public void registerIcons(IIconRegister ir) {
        this.itemIcon = ir.registerIcon("botanicthaumaturgy:sugar_cane_wand_core");
    }
    ...
    public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int targetX, int targetY,
        ...
        if (!world.isRemote) {
            ...
            if (block instanceof BlockArcaneMarble) {
                world.setBlock(targetX, targetY, targetZ, Config.pillarAlpha, 3, 3);
            }

            else if (matrix instanceof TileInfusionMatrix) {

...
public class ShaderUniform
{
    ...
    {
        this.field_148099_g = name;
        this.field_148103_c = count;
        this.field_148100_d = type;
        this.field_148106_i = manager;

        if (type <= 3)
        {
            this.field_148101_e = BufferUtils.createIntBuffer(count);
            this.field_148098_f = null;
        }
        else
        {
            this.field_148101_e = null;
            this.field_148098_f = BufferUtils.createFloatBuffer(count);
        }

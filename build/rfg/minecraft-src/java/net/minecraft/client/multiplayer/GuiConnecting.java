        ...
        (new Thread("Server Connector #" + field_146372_a.incrementAndGet())
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    GuiConnecting.this.field_146371_g = NetworkManager.provideLanClient(inetaddress, port);
                    ...
                    GuiConnecting.this.field_146371_g.scheduleOutboundPacket(new C00Handshake(5, ip, port, EnumConnectionState.LOGIN), new GenericFutureListener[0]);

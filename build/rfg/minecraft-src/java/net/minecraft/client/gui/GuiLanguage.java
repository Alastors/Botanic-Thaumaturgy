        ...
        if (button.enabled)
        {
            switch (button.id)
            {
                ...
                case 100:
                    ...
                    {
                        this.field_146451_g.setOptionValue(((GuiOptionButton)button).returnEnumOptions(), 1);
                        button.displayString = this.field_146451_g.getKeyBinding(GameSettings.Options.FORCE_UNICODE_FONT);

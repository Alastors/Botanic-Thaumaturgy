...
public class ScreenChatOptions extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (button.enabled)
        {
            ...
            {
                this.field_146400_h.setOptionValue(((GuiOptionButton)button).returnEnumOptions(), 1);
                button.displayString = this.field_146400_h.getKeyBinding(GameSettings.Options.getEnumOptions(button.id));
            }

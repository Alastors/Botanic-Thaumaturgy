        ...
        else
        {
            ...
            if (flag)
            {
                if (flag1)
                {
                    ...
                    func_152373_a(sender, this, "commands.xp.success.negative.levels", new Object[] {Integer.valueOf(i), entityplayermp.getCommandSenderName()});
                }
                else
                {
                    entityplayermp.addExperienceLevel(i);
                    func_152373_a(sender, this, "commands.xp.success.levels", new Object[] {Integer.valueOf(i), entityplayermp.getCommandSenderName()});
                }
            }
            else
            {
                ...
                func_152373_a(sender, this, "commands.xp.success", new Object[] {Integer.valueOf(i), entityplayermp.getCommandSenderName()});
            }
        }
    }

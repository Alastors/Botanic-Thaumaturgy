    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        ...
        else
        {
            ...
            if (args[1].equals("clear"))
            {
                ...
                func_152373_a(sender, this, "commands.effect.success.removed.all", new Object[] {entityplayermp.getCommandSenderName()});
            }
            else
            {
                ...
                if (k == 0)
                {
                    ...
                    func_152373_a(sender, this, "commands.effect.success.removed", new Object[] {new ChatComponentTranslation(Potion.potionTypes[i].getName(), new Object[0]), entityplayermp.getCommandSenderName()});
                }
                else
                {
                    PotionEffect potioneffect = new PotionEffect(i, j, l);
                    entityplayermp.addPotionEffect(potioneffect);
                    func_152373_a(sender, this, "commands.effect.success", new Object[] {new ChatComponentTranslation(potioneffect.getEffectName(), new Object[0]), Integer.valueOf(i), Integer.valueOf(l), entityplayermp.getCommandSenderName(), Integer.valueOf(k)});
                }
            }
        }
    }

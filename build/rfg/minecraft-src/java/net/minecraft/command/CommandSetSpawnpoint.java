    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        ...
        if (args.length == 4)
        {
            if (entityplayermp.worldObj != null)
            {
                ...
                func_152373_a(sender, this, "commands.spawnpoint.success", new Object[] {entityplayermp.getCommandSenderName(), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(l)});
            }
        }
        else
        {
            ...
            func_152373_a(sender, this, "commands.spawnpoint.success", new Object[] {entityplayermp.getCommandSenderName(), Integer.valueOf(chunkcoordinates.posX), Integer.valueOf(chunkcoordinates.posY), Integer.valueOf(chunkcoordinates.posZ)});
        }
    }

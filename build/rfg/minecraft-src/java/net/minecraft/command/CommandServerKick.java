    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        if (args.length > 0 && args[0].length() > 1)
        {
            ...
            else
            {
                ...
                if (flag)
                {
                    func_152373_a(sender, this, "commands.kick.success.reason", new Object[] {entityplayermp.getCommandSenderName(), s});
                }
                else
                {
                    func_152373_a(sender, this, "commands.kick.success", new Object[] {entityplayermp.getCommandSenderName()});
                }
            }
        }
        else

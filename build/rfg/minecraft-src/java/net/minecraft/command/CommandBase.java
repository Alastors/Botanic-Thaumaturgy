...
public abstract class CommandBase implements ICommand
{
    ...
    public static EntityPlayerMP getPlayer(ICommandSender sender, String username)
    {
        ...
        {
            entityplayermp = MinecraftServer.getServer().getConfigurationManager().func_152612_a(username);
    ...
    public static String func_96332_d(ICommandSender sender, String query)
    {
    ...
    public static IChatComponent func_147178_a(ICommandSender sender, String[] args, int p_147178_2_)
    {
        return func_147176_a(sender, args, p_147178_2_, false);
    }

    public static IChatComponent func_147176_a(ICommandSender sender, String[] args, int index, boolean p_147176_3_)
    {
    ...
    public static String func_82360_a(ICommandSender sender, String[] args, int index)
    {
    ...
    public static double func_110665_a(ICommandSender sender, double p_110665_1_, String p_110665_3_, int min, int max)
    {
    ...
    public static void func_152373_a(ICommandSender sender, ICommand command, String msgFormat, Object ... msgParams)
    {
        func_152374_a(sender, command, 0, msgFormat, msgParams);
    }
    ...
    public static void func_152374_a(ICommandSender sender, ICommand command, int p_152374_2_, String msgFormat, Object ... msgParams)
    {
        if (theAdmin != null)
        {
            theAdmin.func_152372_a(sender, command, p_152374_2_, msgFormat, msgParams);
        }
    }

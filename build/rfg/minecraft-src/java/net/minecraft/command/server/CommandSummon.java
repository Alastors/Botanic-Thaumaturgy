...
public class CommandSummon extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        ...
        {
            String s = args[0];
            double d0 = (double)sender.getPlayerCoordinates().posX + 0.5D;
            double d1 = (double)sender.getPlayerCoordinates().posY;
            double d2 = (double)sender.getPlayerCoordinates().posZ + 0.5D;

            if (args.length >= 4)
            {
                d0 = func_110666_a(sender, d0, args[1]);
                d1 = func_110666_a(sender, d1, args[2]);
                d2 = func_110666_a(sender, d2, args[3]);
            }
            ...
            {
                func_152373_a(sender, this, "commands.summon.outOfWorld", new Object[0]);
            }
            else
            {
                ...
                if (args.length >= 5)
                {
                    IChatComponent ichatcomponent = func_147178_a(sender, args, 4);
                ...
                else
                {
                    ...
                    func_152373_a(sender, this, "commands.summon.success", new Object[0]);
                }
            }
        }
    }

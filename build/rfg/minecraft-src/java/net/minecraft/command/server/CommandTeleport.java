        ...
        else
        {
            ...
            if (args.length != 3 && args.length != 4)
            {
                if (args.length == 1 || args.length == 2)
                {
                    ...
                    {
                        func_152373_a(sender, this, "commands.tp.notSameDimension", new Object[0]);
                        return;
                    }
                    ...
                    func_152373_a(sender, this, "commands.tp.success", new Object[] {entityplayermp.getCommandSenderName(), entityplayermp1.getCommandSenderName()});
                }
            }
            else if (entityplayermp.worldObj != null)
            {
                int i = args.length - 3;
                double d0 = func_110666_a(sender, entityplayermp.posX, args[i++]);
                double d1 = func_110665_a(sender, entityplayermp.posY, args[i++], 0, 0);
                double d2 = func_110666_a(sender, entityplayermp.posZ, args[i++]);
                entityplayermp.mountEntity((Entity)null);
                entityplayermp.setPositionAndUpdate(d0, d1, d2);
                func_152373_a(sender, this, "commands.tp.success.coordinates", new Object[] {entityplayermp.getCommandSenderName(), Double.valueOf(d0), Double.valueOf(d1), Double.valueOf(d2)});
            }
        }
    }

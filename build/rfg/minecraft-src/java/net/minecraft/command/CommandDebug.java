...
public class CommandDebug extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        if (args.length == 1)
        {
            ...
            {
                func_152373_a(sender, this, "commands.debug.start", new Object[0]);
            ...
            if (args[0].equals("stop"))
            {
                ...
                func_152373_a(sender, this, "commands.debug.stop", new Object[] {Float.valueOf((float)k / 1000.0F), Integer.valueOf(l)});
                return;
            }
        }

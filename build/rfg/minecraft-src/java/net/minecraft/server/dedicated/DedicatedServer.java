...
public class DedicatedServer extends MinecraftServer implements IServer
{
    ...
    {
        playerSnooper.func_152768_a("whitelist_enabled", Boolean.valueOf(this.getConfigurationManager().isWhiteListEnabled()));
        playerSnooper.func_152768_a("whitelist_count", Integer.valueOf(this.getConfigurationManager().func_152598_l().length));
    ...
    public boolean isBlockProtected(World inWorld, int x, int y, int z, EntityPlayer player)
    {
        ...
        else if (this.getConfigurationManager().func_152596_g(player.getGameProfile()))
        {
            return false;
        }

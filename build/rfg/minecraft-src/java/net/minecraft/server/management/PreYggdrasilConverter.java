...
public class PreYggdrasilConverter
{
    ...
    private static void func_152717_a(MinecraftServer server, Collection names, ProfileLookupCallback callback)
    {
        ...
        {
            server.func_152359_aw().findProfilesByNames(astring, Agent.MINECRAFT, callback);
        }
        else
        {
    ...
    static List func_152721_a(File inFile, Map read) throws IOException
    {
    ...
    @SideOnly(Side.SERVER)
    public static boolean func_152724_a(final MinecraftServer server) throws IOException
    {
        ...
        if (field_152729_b.exists() && field_152729_b.isFile())
        {
            ...
            try
            {
                ...
                ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback()
                {
                    ...
                    public void onProfileLookupSucceeded(GameProfile p_onProfileLookupSucceeded_1_)
                    {
                        server.func_152358_ax().func_152649_a(p_onProfileLookupSucceeded_1_);
                ...
                func_152717_a(server, hashmap.keySet(), profilelookupcallback);
    ...
    @SideOnly(Side.SERVER)
    public static boolean func_152722_b(MinecraftServer server) throws IOException
    {
    ...
    @SideOnly(Side.SERVER)
    public static boolean func_152718_c(final MinecraftServer server) throws IOException
    {
        ...
        if (field_152730_c.exists() && field_152730_c.isFile())
        {
            ...
            try
            {
                ...
                ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback()
                {
                    ...
                    {
                        server.func_152358_ax().func_152649_a(p_onProfileLookupSucceeded_1_);
                        userlistops.func_152687_a(new UserListOpsEntry(p_onProfileLookupSucceeded_1_, server.getOpPermissionLevel()));
                    }
                    public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_, Exception p_onProfileLookupFailed_2_)
                    {
                ...
                func_152717_a(server, list, profilelookupcallback);
    ...
    @SideOnly(Side.SERVER)
    public static boolean func_152710_d(final MinecraftServer server) throws IOException
    {
    ...
    @SideOnly(Side.SERVER)
    public static boolean func_152723_a(final DedicatedServer server, PropertyManager p_152723_1_)
    {
        ...
        if (file1.exists() && file1.isDirectory())
        {
            ...
            try
            {
                ...
                func_152717_a(server, Lists.newArrayList(astring), profilelookupcallback);
                return true;
            }
            catch (PreYggdrasilConverter.ConversionError preyggdrasilconverterconversionerror)
            {
    ...
    @SideOnly(Side.SERVER)
    private static void func_152711_b(File dir)
    {
        if (dir.exists())
        {
            if (!dir.isDirectory())
    ...
    @SideOnly(Side.SERVER)
    public static boolean func_152714_a(PropertyManager properties)
    {
        boolean flag = func_152712_b(properties);
        flag = flag && func_152715_c(properties);
        return flag;
    }

    @SideOnly(Side.SERVER)
    private static boolean func_152712_b(PropertyManager properties)
    {
        boolean flag = false;
    ...
    @SideOnly(Side.SERVER)
    private static boolean func_152715_c(PropertyManager properties)
    {
        File file1 = func_152725_d(properties);
    ...
    @SideOnly(Side.SERVER)
    private static File func_152725_d(PropertyManager properties)
    {
    ...
    @SideOnly(Side.SERVER)
    private static void func_152727_c(File convertedFile)
    {
    ...
    @SideOnly(Side.SERVER)
    private static Date func_152713_b(String input, Date defaultValue)
    {
        Date date1;

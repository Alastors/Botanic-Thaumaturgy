...
public class EntityFishHook extends Entity
{
    ...
    public void setPositionAndRotation2(double x, double y, double z, float yaw, float pitch, int rotationIncrements)
    {
        ...
        this.field_146059_aF = (double)yaw;
        this.field_146060_aG = (double)pitch;
    ...
    {
        this.field_146061_aH = this.motionX = x;
        this.field_146052_aI = this.motionY = y;
        this.field_146053_aJ = this.motionZ = z;
    }
    ...
    {
        tagCompound.setShort("xTile", (short)this.field_146037_g);
        tagCompound.setShort("yTile", (short)this.field_146048_h);
        tagCompound.setShort("zTile", (short)this.field_146050_i);
        tagCompound.setByte("inTile", (byte)Block.getIdFromBlock(this.field_146046_j));
        tagCompound.setByte("shake", (byte)this.field_146044_a);
        tagCompound.setByte("inGround", (byte)(this.field_146051_au ? 1 : 0));
    }
    ...
    {
        this.field_146037_g = tagCompund.getShort("xTile");
        this.field_146048_h = tagCompund.getShort("yTile");
        this.field_146050_i = tagCompund.getShort("zTile");
        this.field_146046_j = Block.getBlockById(tagCompund.getByte("inTile") & 255);
        this.field_146044_a = tagCompund.getByte("shake") & 255;
        this.field_146051_au = tagCompund.getByte("inGround") == 1;
    }

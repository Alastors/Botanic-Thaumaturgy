...
public class S00PacketDisconnect extends Packet
{
    ...
    {
        this.field_149605_a = IChatComponent.Serializer.func_150699_a(data.readStringFromBuffer(32767));
    }
    ...
    {
        data.writeStringToBuffer(IChatComponent.Serializer.func_150696_a(this.field_149605_a));
    }

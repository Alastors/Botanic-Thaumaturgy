...
public class S00PacketServerInfo extends Packet
{
    ...
    {
        this.field_149296_b = responseIn;
    }
    ...
    {
        this.field_149296_b = (ServerStatusResponse)field_149297_a.fromJson(data.readStringFromBuffer(32767), ServerStatusResponse.class);
    }
    ...
    {
        data.writeStringToBuffer(field_149297_a.toJson(this.field_149296_b));
    }

...
public class C15PacketClientSettings extends Packet
{
    ...
    {
        this.field_149530_a = data.readStringFromBuffer(7);
        this.field_149528_b = data.readByte();
        this.field_149529_c = EntityPlayer.EnumChatVisibility.getEnumChatVisibility(data.readByte());
        this.field_149526_d = data.readBoolean();
        this.field_149527_e = EnumDifficulty.getDifficultyEnum(data.readByte());
        this.field_149525_f = data.readBoolean();
    }
    ...
    {
        data.writeStringToBuffer(this.field_149530_a);
        data.writeByte(this.field_149528_b);
        data.writeByte(this.field_149529_c.getChatVisibility());
        data.writeBoolean(this.field_149526_d);
        data.writeByte(this.field_149527_e.getDifficultyId());
        data.writeBoolean(this.field_149525_f);
    }

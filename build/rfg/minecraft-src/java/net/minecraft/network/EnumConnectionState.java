...
public enum EnumConnectionState
{
    ...
    private EnumConnectionState(int protocolId)
    {
        ...
        this.field_150762_g = protocolId;
    }
    ...
    public static EnumConnectionState func_150760_a(int stateId)
    {
        return (EnumConnectionState)field_150764_e.get(stateId);
    }

    public static EnumConnectionState func_150752_a(Packet packetIn)
    {
        return (EnumConnectionState)field_150761_f.get(packetIn.getClass());
    }
